...
<head>
    ...
    <title>Suppliers - SuperPOS</title>
    ...
    <style>
        ...
        .modal-content { background: var(--card-bg); width: 100%; max-width: 500px; border-radius: var(--radius-lg); padding: 2rem; transform: translateY(-20px); transition: transform 0.3s; }
...
<body>
        ...
        <div class="main-wrapper">
            ...
            <main class="main-content">
                <div class="page-header">
                    <div>
                        <h1>Suppliers</h1>
                        <p class="text-muted">Manage your inventory providers</p>
                    </div>
    ...
    <div class="modal" id="dataModal">
        <div class="modal-content">
            <h2 id="modalTitle" style="margin-bottom: 1.5rem;">Add Supplier</h2>
            <form id="dataForm">
                ...
                <div style="margin-bottom: 1rem;">
                    ...
                    <input type="text" id="recordPhone" class="form-control">
                </div>
                <div style="margin-bottom: 1.5rem;">
                    <label class="form-label">Address</label>
                    <textarea id="recordAddress" class="form-control" rows="3"></textarea>
                </div>
    ...
    <script>
        ...
        async function fetchData() {
            ...
            if (data.suppliers.length === 0) {
                tbody.innerHTML = '<tr><td colspan="4" style="text-align:center;">No suppliers</td></tr>';
                return;
            }
        ...
        function openModal(action, item = null) {
            ...
            document.getElementById('modalTitle').textContent = action === 'add' ? 'Add Supplier' : 'Edit Supplier';
            if (action === 'add') {
                ...
                document.getElementById('recordPhone').value = item.phone;
                document.getElementById('recordAddress').value = item.address;
            }
        ...
        document.getElementById('dataForm').addEventListener('submit', async (e) => {
            ...
            const res = await fetch('../api/suppliers.php', { method: 'POST', body: JSON.stringify(payload) });
            const data = await res.json();
        ...
        async function deleteRecord(id) {
            ...
            const res = await fetch('../api/suppliers.php', { method: 'POST', body: JSON.stringify({action: 'delete', id: id, csrf_token: csrfToken}) });
            const data = await res.json();
